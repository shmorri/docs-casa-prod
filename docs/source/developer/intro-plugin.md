...
1. Connect to your VM and log in to Gluu chroot (e.g. `service gluu-server login`)
...
You can use any of the resources listed above to get an idea of how typical zul files look. Additionally you may check the code of [Gluu Casa project](https://github.com/GluuFederation/casa/tree/version_4.0/app/src/main/webapp) where you'll find many zul files. In the [Writing your first plugin](first-plugin.md) page you will have the opportunity to view and edit a .zul file your own.
